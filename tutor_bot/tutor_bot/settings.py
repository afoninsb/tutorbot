...
STUDENT_FREE_TARIF = 6  # количество учащихся в бесплатном тарифе = Количество учащихся + Сам админ-учитель (3+1=4 - 3 учащихся)

TASKS_PER_PAGE = 15  # количество задач на странице
